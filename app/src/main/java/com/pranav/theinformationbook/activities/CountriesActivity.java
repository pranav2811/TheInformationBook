...
import com.pranav.theinformationbook.adapters.ViewPagerAdapterCountries;
...
public class CountriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerCountries.setAdapter(adapter);//we use this method to connect the adapter method to the recycler view


        //now we need to link the tab layout and view pager components
